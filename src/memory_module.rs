...
pub type CustomAllocFunction = fn(size: usize, allocation_type: u32, protect: u32, user_data: *mut std::ffi::c_void) -> *mut u8;
pub type CustomFreeFunction = fn(ptr: *mut u8, size: usize, free_type: u32, user_data: *mut std::ffi::c_void) -> bool;
pub type CustomLoadLibraryFunction = fn(filename: &OsStr, user_data: *mut std::ffi::c_void) -> *mut std::ffi::c_void;
pub type CustomGetProcAddressFunction = fn(module: *mut std::ffi::c_void, name: &str, user_data: *mut std::ffi::c_void) -> *const u8;
pub type CustomFreeLibraryFunction = fn(module: *mut std::ffi::c_void, user_data: *mut std::ffi::c_void) -> bool;
